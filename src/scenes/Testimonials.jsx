        ...
        <section id="testimonials" className="pt-32 pb-16">
            ...
            >
                ...
                <p className="mt-10 mb-7">
                    Dodit cupiditate eaque, tempora repudiandae temporibus perspiciatis ipsam dolorem nesciunt magnam rem?
                </p>
            </motion.div>
            ...
            <div className="md:flex md:justify-between gap-8">
                ...
                >
                   ...
                   <p className="ftext-center text-xl">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>                    
                </motion.div>
